...
// @updateURL       https://github.com/jxn-30/LSS-Scripts/raw/master/src/hideStaffCounter.user.js
// @downloadURL     https://github.com/jxn-30/LSS-Scripts/raw/master/src/hideStaffCounter.user.js
...
/**
 * @name Hide Staff Counter
 * @name:de Personalzähler ausblenden
 * @description Hides the staff counter in missions.
 * @description:de Blendet den Personalzähler in Einsätzen aus.
 * @match /missions/*
 * @grant GM_addStyle
...
GM_addStyle(
    `small:has(> #amount_of_people) {display: none; & + div {width: 100%}}`
);
