...
// @updateURL    https://github.com/jxn-30/LSS-Scripts/raw/master/src/lufsiInConsole.user.js
// @downloadURL  https://github.com/jxn-30/LSS-Scripts/raw/master/src/lufsiInConsole.user.js
...
/**
 * @name LUFSI-Framework in console
 * @description Adds the tools of LUFSI-Framework to window object to allow using them in console
 * @match *
 * @grant unsafeWindow
...
unsafeWindow.sharedAPIStorage = sharedAPIStorage;
