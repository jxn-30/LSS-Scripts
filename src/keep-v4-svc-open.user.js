...
// @updateURL       https://github.com/jxn-30/LSS-Scripts/raw/master/src/keep-v4-svc-open.user.js
// @downloadURL     https://github.com/jxn-30/LSS-Scripts/raw/master/src/keep-v4-svc-open.user.js
...
/**
 * @name Keep LSSM V.4 vehicle counter open
 * @name:de LSSM V.4 Fahrzeugzähler offen halten
 * @description Keeps the dropup that counts selected vehicles open
 * @description:de Hält has Dropup, das die ausgewählten Fahrzeuge zählt, offen
 * @match /missions/*
 * @grant GM_addStyle
...
GM_addStyle(
    `#lssmv4-extendedCallWindow_svc_table { display: block !important; }`
);
