...
// @updateURL       https://github.com/jxn-30/LSS-Scripts/raw/master/src/checkboxMultiselect.user.js
// @downloadURL     https://github.com/jxn-30/LSS-Scripts/raw/master/src/checkboxMultiselect.user.js
// @supportURL      https://forum.leitstellenspiel.de/index.php?thread/22814-script-checkbox-multiselect/
 ...
 * @description Allows to select multiple checkbox in a row by pressing the shift key
 * @description:de Erlaubt es, eine Reihe an Checkboxen durch halten der Umschalt-Taste auf einmal auszuwählen
 * @forum https://forum.leitstellenspiel.de/index.php?thread/22814-script-checkbox-multiselect/
 * @old checkbox-multiselect
 */

(() => {
    let firstCheckbox = null;
    const firstCheckboxParentClass =
        'checkbox-multiselect-first-checkbox-parent';
