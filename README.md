...
|:--------:|:------------:|:-----------------:|:-------------------------------------------------------------:|:---------------------------------------:|
| 2022.0.0 |    `🇩🇪`    |   `aao-lite-de`   | [aaoConfigLite.de.user.js][aaoConfigLite.de.user.js:download] | [Forum][aaoConfigLite.de.user.js:forum] |
...
|:--------:|:-------------------:|:-------------------------------------------------------------:|:---------------------------------------:|
| 2022.0.0 | `Alliance-Distance` | [allianceDistance.user.js][allianceDistance.user.js:download] | [Forum][allianceDistance.user.js:forum] |
...
| Version  |     Alias / Old names      |                                 Download                                  |                     Links                     |
|:--------:|:--------------------------:|:-------------------------------------------------------------------------:|:---------------------------------------------:|
| 2022.0.0 | `Alliance-Member-Distance` | [allianceMemberDistance.user.js][allianceMemberDistance.user.js:download] | [Forum][allianceMemberDistance.user.js:forum] |
...
| Version  |    Alias / Old names    |                              Download                               |                   Links                    |
|:--------:|:-----------------------:|:-------------------------------------------------------------------:|:------------------------------------------:|
| 2022.0.0 | `Alliance-Member-Notes` | [allianceMemberNotes.user.js][allianceMemberNotes.user.js:download] | [Forum][allianceMemberNotes.user.js:forum] |
...
| Version  |    Alias / Old names    |                              Download                               |                   Links                    |
|:--------:|:-----------------------:|:-------------------------------------------------------------------:|:------------------------------------------:|
| 2022.0.0 | `arr_categories_export` | [arrCategoriesExport.user.js][arrCategoriesExport.user.js:download] | [Forum][arrCategoriesExport.user.js:forum] |
...
| Version  |    Alias / Old names     |                     Download                      |               Links               |
|:--------:|:------------------------:|:-------------------------------------------------:|:---------------------------------:|
| 2022.0.0 | `arr-counter-standalone` | [arrCounter.user.js][arrCounter.user.js:download] | [Forum][arrCounter.user.js:forum] |
...
| Version  | Available in | Alias / Old names |                         Download                          |                 Links                 |
|:--------:|:------------:|:-----------------:|:---------------------------------------------------------:|:-------------------------------------:|
| 2022.0.0 |    `🇩🇪`    | `Async-Prisoners` | [asyncPrisoners.user.js][asyncPrisoners.user.js:download] | [Forum][asyncPrisoners.user.js:forum] |
...
|:--------:|:---------------------:|:-------------------------------------------------------------------------:|
| 2022.0.0 | `bsr-aao-vehiclelist` | [bsrAAOAboveVehiclelist.user.js][bsrAAOAboveVehiclelist.user.js:download] |
...
| Version  |        Alias / Old names        |                                      Download                                       |
|:--------:|:-------------------------------:|:-----------------------------------------------------------------------------------:|
| 2022.0.0 | `Leitstellenansicht-Nav-toggle` | [navToggleLeitstellenansicht.user.js][navToggleLeitstellenansicht.user.js:download] |
...
| Version  |   Alias / Old names   |                             Download                              |                   Links                   |
|:--------:|:---------------------:|:-----------------------------------------------------------------:|:-----------------------------------------:|
| 2022.0.0 | `reload-buildinglist` | [reloadBuildinglist.user.js][reloadBuildinglist.user.js:download] | [Forum][reloadBuildinglist.user.js:forum] |
...
| Version  | Alias / Old names |                      Download                       |               Links                |
|:--------:|:-----------------:|:---------------------------------------------------:|:----------------------------------:|
| 2022.0.0 |  `scroll-to-top`  | [scrollToTop.user.js][scrollToTop.user.js:download] | [Forum][scrollToTop.user.js:forum] |
...
| Version  | Alias / Old names  |                          Download                           |                 Links                  |
|:--------:|:------------------:|:-----------------------------------------------------------:|:--------------------------------------:|
| 2022.0.0 | `Toplist-Distance` | [toplistDistance.user.js][toplistDistance.user.js:download] | [Forum][toplistDistance.user.js:forum] |
