...
(function() {
    ...
    function renderStatus() {
        ...
        $('#statusCount .building_list_fms_5').css('background-image', (!s5blink && $('#radio_messages_important .building_list_fms_5:visible').length === 0) ? 'url()' : 'url(/images/fms5_background.gif)');
