...
(function() {
    ...
    function renderStatus() {
        ...
        s5 ? $("#statusCount").append('<span class="building_list_fms building_list_fms_5" title="Status 5: ' + $('#radio_panel_body .building_list_fms_5').length + '">' + $('#radio_panel_body .building_list_fms_5').length + '</span>') : null;
        ...
        $('#statusCount .building_list_fms_5').css('background-image', (!s5blink && $('#radio_panel_body .building_list_fms_5').length === 0) ? 'url()' : 'url(/images/fms5_background.gif)');
    }
